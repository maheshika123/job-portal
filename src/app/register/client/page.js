...
export default function ClientRegister() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Client registration:', formData, photo);
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white/5 backdrop-blur-lg rounded-xl p-8 border border-white/10">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white">Client Registration</h2>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Profile Photo */}
              <div className="md:col-span-2">
                <label htmlFor="photo" className="block text-sm font-medium text-gray-300">Company Logo</label>
                <div className="mt-1 flex items-center space-x-4">
                  <div className="h-24 w-24 rounded-full overflow-hidden bg-white/10 flex items-center justify-center">
                    {photoPreview ? (
                      <img src={photoPreview} alt="Company logo preview" className="h-full w-full object-cover" />
                    ) : (
